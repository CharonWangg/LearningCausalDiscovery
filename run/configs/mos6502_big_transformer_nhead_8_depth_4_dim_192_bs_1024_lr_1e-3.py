...
log = dict(
    ...
    work_dir="work_dir",
    exp_name="mos6502_big_transformer_nhead_8_depth_4_dim_192_bs_1024_lr_1e-3",
    logger_interval=50,
...
resume_from = '/project/lcd_v2/work_dir/mos6502_big_transformer_nhead_8_depth_4_dim_192_bs_1024_lr_1e-3/ckpts/last.ckpt'
