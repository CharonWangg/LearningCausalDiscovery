...
log = dict(
    project_name="netsim",
    work_dir="work_dir",
    exp_name="sldisco_node_10_n_samples_10000",
    logger_interval=50,
    monitor="val_loss_epoch",
    logger=None,
    checkpoint=dict(
        type="ModelCheckpoint", top_k=1, mode="min", verbose=True, save_last=False
    ),
    earlystopping=dict(
        mode="min",
        strict=False,
...
optimization = dict(
    ...
    scheduler=dict(type="CosineAnnealing", interval="step", min_lr=1e-06, warmup=None),
)
