...
def run_on_data(i, method, files_input_name, verbose):
    ...
    if save_model:
        if not os.path.exists("./experiments/graphs/summary_other_and_self_graphs/fmri"):
            os.makedirs("./experiments/graphs/summary_other_and_self_graphs/fmri")
        if not os.path.exists("./experiments/graphs/summary_other_graphs/fmri/"):
            os.makedirs("./experiments/graphs/summary_other_graphs/fmri/")
        if not os.path.exists("./experiments/graphs/summary_self_graphs/fmri/"):
            os.makedirs("./experiments/graphs/summary_self_graphs/fmri/")
    ...
    if not isinstance(model, cd.TemporalGraphicalModel):
        ...
        if save_model:
            if not os.path.exists("./experiments/graphs/temporal_graphs/fmri/"):
                os.makedirs("./experiments/graphs/temporal_graphs/fmri/")
...
if __name__ == "__main__":
    ...
    if not os.path.exists("./experiments/performance_average/summary_other_and_self_performance_average/"):
        os.makedirs("./experiments/performance_average/summary_other_and_self_performance_average/")
    ...
    if not os.path.exists("./experiments/performance_average/summary_other_performance_average/"):
        os.makedirs("./experiments/performance_average/summary_other_performance_average/")
    with open(
    ...
    if not os.path.exists("./experiments/performance_average/summary_self_performance_average/"):
        os.makedirs("./experiments/performance_average/summary_self_performance_average/")
    with open(
    ...
    if results.shape[1] > 16:
        ...
        if not os.path.exists("./experiments/performance_average/temporal_performance_average/"):
            os.makedirs("./experiments/performance_average/temporal_performance_average/")
        if not os.path.exists("./experiments/performance_detail/"):
            os.makedirs("./experiments/performance_detail/")
        with open(
